import { Bell, PanelLeft, UserCircle } from "lucide-react";
        ...
        <div className="p-2">
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg p-2.5 px-4 text-black bg-slate-100 outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition"
            />
          </div>
        </div>
      </div>
